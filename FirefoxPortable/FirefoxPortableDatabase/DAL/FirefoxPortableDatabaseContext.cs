...
namespace FirefoxPortableDatabase.DAL
{
    class FirefoxPortableDatabaseContext : DbContext
    {
        ...
        public FirefoxPortableDatabaseContext() : base("Data Source=112.78.2.40;Initial Catalog=exa61210_FirefoxPortableDB;User Id=exa61210_FirefoxPortableDB;Password=z2~8E4py")
        {

        }

        //public FirefoxPortableDatabaseContext() : base("Data Source=.;Initial Catalog=FirefoxPortableDB;User Id=sa;Password=123123")
        //{
        //}
